    ...
    29007: (t, e, r) => {
      ...
      class s extends o.Vw {
        ...
        update(t) {
          ...
          let { view: e, buffer: r, blockLen: n } = this,
            s = (t = (0, o.ZJ)(t)).length;
          for (let i = 0; i < s; ) {
            let f = Math.min(n - this.pos, s - i);
            if (f === n) {
              let e = (0, o.O8)(t);
              for (; n <= s - i; i += n) this.process(e, i);
              continue;
            }
            r.set(t.subarray(i, i + f), this.pos),
              (this.pos += f),
              (i += f),
        ...
        digestInto(t) {
          ...
          (e[f++] = 128),
            ...
            this.padOffset > n - f && (this.process(r, 0), (f = 0));
          for (let t = f; t < n; t++) e[t] = 0;
          !(function (t, e, r, n) {
            ...
            let i = BigInt(32),
              ...
              l = 4 * !!n,
              a = 4 * !n;
            t.setUint32(e + l, s, n), t.setUint32(e + a, f, n);
        ...
        _cloneInto(t) {
          ...
          let { blockLen: e, buffer: r, length: n, finished: i, destroyed: o, pos: s } = this;
          return (
            (t.length = n),
            (t.pos = s),
            (t.finished = i),
      ...
      class u extends s {
        ...
        process(t, e) {
          ...
          for (let t = 16; t < 64; t++) {
            let e = a[t - 15],
              r = a[t - 2],
              n = (0, o.Ow)(e, 7) ^ (0, o.Ow)(e, 18) ^ (e >>> 3),
              i = (0, o.Ow)(r, 17) ^ (0, o.Ow)(r, 19) ^ (r >>> 10);
            a[t] = (i + a[t - 7] + n + a[t - 16]) | 0;
          }
          let { A: r, B: n, C: i, D: s, E: l, F: u, G: h, H: d } = this;
          for (let t = 0; t < 64; t++) {
            var c, g, p, w;
            let e =
                (d +
                ...
                0,
              y =
                (((0, o.Ow)(r, 2) ^ (0, o.Ow)(r, 13) ^ (0, o.Ow)(r, 22)) +
                  (((g = r) & (p = n)) ^ (g & (w = i)) ^ (p & w))) |
                0;
            (d = h),
              (h = u),
      ...
      class d extends o.Vw {
        ...
        _cloneInto(t) {
          ...
          let { oHash: e, iHash: r, finished: n, destroyed: i, blockLen: o, outputLen: s } = this;
          return (
            (t.finished = n),
            (t.destroyed = i),
            (t.blockLen = o),
      ...
      let c = (t, e, r) => new d(t, e).update(r).digest();
      c.create = (t, e) => new d(t, e);
      let g = BigInt(0),
        p = BigInt(1),
        w = BigInt(2);
      function y(t) {
      ...
      function m(t) {
        if (!y(t)) throw Error("Uint8Array expected");
      }
      function b(t, e) {
        if ("boolean" != typeof e) throw Error(t + " boolean expected, got " + e);
      }
      let x = Array.from({ length: 256 }, (t, e) => e.toString(16).padStart(2, "0"));
      function E(t) {
        m(t);
        let e = "";
      ...
      let A = { _0: 48, _9: 57, A: 65, F: 70, a: 97, f: 102 };
      function O(t) {
      ...
      function I(t) {
        ...
        for (let e = 0, i = 0; e < r; e++, i += 2) {
          let r = O(t.charCodeAt(i)),
            o = O(t.charCodeAt(i + 1));
      ...
      function q(t) {
        return m(t), v(E(Uint8Array.from(t).reverse()));
      }
      function R(t, e) {
      ...
      function H(t, e, r) {
        ...
        else if (y(e)) n = Uint8Array.from(e);
      ...
      let L = (t) => "bigint" == typeof t && g <= t;
      function U(t, e, r) {
        return L(t) && L(e) && L(r) && e <= t && t < r;
      }
      function z(t, e, r, n) {
        if (!U(e, r, n))
      ...
      let T = {
        ...
        stringOrUint8Array: (t) => "string" == typeof t || y(t),
      ...
      function $(t, e) {
        if (t === D) throw Error("invert: expected non-zero number");
        if (e <= D) throw Error("invert: expected positive modulus, got " + e);
        let r = Q(t, e),
          n = e,
          i = D,
          o = K,
      ...
      function tr(t, e, r = !1, n = {}) {
        let i;
        if (t <= D) throw Error("invalid field: expected ORDER > 0, got " + t);
        let { nBitLength: o, nByteLength: s } = te(t, e);
        ...
        let f = Object.freeze({
          ...
          pow: (t, e) =>
            (function (t, e, r) {
              if (r < D) throw Error("invalid exponent, negatives unsupported");
              if (r === D) return t.ONE;
              if (r === K) return e;
              let n = t.ONE,
                i = e;
              for (; r > D; ) r & K && (n = t.mul(n, i)), (i = t.sqr(i)), (r >>= K);
              return n;
            })(f, t, e),
          div: (e, r) => Q(e * $(r, t), t),
          sqrN: (t) => t * t,
                ...
                (i = (function (t) {
                  ...
                  return (function (t) {
                    let e,
                      ...
                      n,
                      i = (t - K) / M;
                    for (e = t - K, r = 0; e % M === D; e /= M, r++);
                    for (
                      n = M;
                      n < t &&
                      (function (t, e, r) {
                        if (e < D) throw Error("invalid exponent, negatives unsupported");
                        if (r <= D) throw Error("invalid modulus");
                        if (r === K) return D;
                        let n = K;
                        for (; e > D; ) e & K && (n = (n * t) % r), (t = (t * t) % r), (e >>= K);
                        return n;
                      })(n, i, t) !==
                        t - K;
                      n++
                    ...
                    let o = (e + K) / M;
                    return function (t, s) {
                      if (t.pow(s, i) === t.neg(t.ONE)) throw Error("Cannot find square root");
                      let f = r,
                      ...
                      for (; !t.eql(u, t.ONE); ) {
                        ...
                        let r = t.pow(l, K << BigInt(f - e - 1));
                        (l = t.sqr(r)), (a = t.mul(a, r)), (u = t.mul(u, l)), (f = e);
                      }
                      return a;
                    };
                  })(t);
          ...
          cmov: (t, e, r) => (r ? e : t),
          toBytes: (t) => (r ? N(t, s) : R(t, s)),
          fromBytes: (t) => {
            if (t.length !== s)
              throw Error("Field.fromBytes: expected " + s + " bytes, got " + t.length);
            return r ? q(t) : S(t);
          },
        });
      ...
      function ta(t, e) {
        return tl(t, e), { windows: Math.ceil(e / t) + 1, windowSize: 2 ** (t - 1) };
      }
      let tu = new WeakMap(),
        th = new WeakMap();
      function td(t) {
      ...
      function tc(t) {
        return (
          ...
          Object.freeze({ ...te(t.n, t.nBitLength), ...t, ...{ p: t.Fp.ORDER } })
        );
      }
      function tg(t) {
        void 0 !== t.lowS && b("lowS", t.lowS), void 0 !== t.prehash && b("prehash", t.prehash);
      }
      let { Ph: tp, aT: tw } = n;
      ...
      let tm = {
          ...
          _int: {
            encode(t) {
              let { Err: e } = tm;
              if (t < tb) throw new e("integer: negative integers are not allowed");
              let r = B(t);
        ...
        tb = BigInt(0),
        tx = BigInt(1),
        tE = (BigInt(2), BigInt(3)),
        tB =
          (BigInt(4), BigInt("0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffefffffc2f")),
        tv = BigInt("0xfffffffffffffffffffffffffffffffebaaedce6af48a03bbfd25e8cd0364141"),
        tA = BigInt(1),
        tO = BigInt(2),
        tI = (t, e) => (t + e / tO) / e,
        tS = tr(tB, void 0, void 0, {
          sqrt: function (t) {
            let e = BigInt(3),
              r = BigInt(6),
              n = BigInt(11),
              ...
              x = (X(b, r, tB) * l) % tB,
              E = X(x, tO, tB);
            if (!tS.eql(tS.sqr(E), t)) throw Error("Cannot find square root");
            return E;
          },
        }),
        tq = (function (t, e) {
          let r = (e) =>
            (function (t) {
              ...
              let {
                  ...
                  function l(t) {
                    let e,
                      { allowedPrivateKeyLengths: n, nByteLength: i, wrapPrivateKey: o, n: s } = r;
                    if (n && "bigint" != typeof t) {
                      if ((y(t) && (t = E(t)), "string" != typeof t || !n.includes(t.length)))
                        throw Error("invalid private key");
                      t = t.padStart(2 * i, "0");
                    }
                    try {
                      e = "bigint" == typeof t ? t : S(H("private key", t, i));
                    } catch (e) {
                      throw Error(
                        "invalid private key, expected hex or " + i + " bytes, got " + typeof t,
                      );
                    }
                    return o && (e = Q(e, s)), z("private key", e, tx, s), e;
                  }
                  function a(t) {
                  ...
                  let u = j((t, e) => {
                    ...
                    h = j((t) => {
                      ...
                      let o = n.sqr(i),
                        s = f(e);
                      if (!n.eql(o, s)) throw Error("bad point: equation left != right");
                  ...
                  class d {
                    ...
                    static fromHex(t) {
                      let e = d.fromAffine(s(H("pointHex", t)));
                    ...
                    static msm(t, e) {
                      return (function (t, e, r, n) {
                        ...
                        for (let t = a; t >= 0; t -= s) {
                          ...
                          let e = i;
                          for (let t = l.length - 1, r = i; t > 0; t--)
                            (r = r.add(l[t])), (e = e.add(r));
                          if (((u = u.add(e)), 0 !== t)) for (let t = 0; t < s; t++) u = u.double();
                        }
                        return u;
                      })(d, i, t, e);
                    }
                    ...
                    equals(t) {
                      ...
                      let { px: e, py: r, pz: i } = this,
                        { px: o, py: s, pz: f } = t,
                        l = n.eql(n.mul(e, f), n.mul(o, i)),
                        u = n.eql(n.mul(r, f), n.mul(s, i));
                      return l && u;
                    }
                    negate() {
                    ...
                    add(t) {
                      ...
                      let { px: e, py: i, pz: o } = this,
                        ...
                        b = n.add(e, i),
                        x = n.add(s, f);
                      (b = n.mul(b, x)), (x = n.add(w, y)), (b = n.sub(b, x)), (x = n.add(e, o));
                      let E = n.add(s, l);
                      return (
                        (x = n.mul(x, E)),
                        (E = n.add(w, m)),
                    ...
                    wNAF(t) {
                      return g.wNAFCached(this, t, d.normalizeZ);
                    }
                    multiplyUnsafe(t) {
                      let { endo: e, n: i } = r;
                      z("scalar", t, tb, i);
                      let o = d.ZERO;
                      if (t === tb) return o;
                      if (this.is0() || t === tx) return this;
                      if (!e || g.hasPrecomputes(this))
                        return g.wNAFCachedUnsafe(this, t, d.normalizeZ);
                      let { k1neg: s, k1: f, k2neg: l, k2: a } = e.splitScalar(t),
                        u = o,
                        h = o,
                        c = this;
                      for (; f > tb || a > tb; )
                      ...
                      return (
                        s && (u = u.negate()),
                        l && (h = h.negate()),
                        (h = new d(n.mul(h.px, e.beta), h.py, h.pz)),
                        u.add(h)
                      );
                    }
                    multiply(t) {
                      let e,
                        i,
                        { endo: o, n: s } = r;
                      if ((z("scalar", t, tx, s), o)) {
                        let { k1neg: r, k1: s, k2neg: f, k2: l } = o.splitScalar(t),
                          { p: a, f: u } = this.wNAF(s),
                          { p: h, f: c } = this.wNAF(l);
                        (a = g.constTimeNegate(r, a)),
                          (h = g.constTimeNegate(f, h)),
                          (h = new d(n.mul(h.px, o.beta), h.py, h.pz)),
                          (e = a.add(h)),
                          (i = u.add(c));
                      } else {
                      ...
                      return d.normalizeZ([e, i])[0];
                    }
                    multiplyAndAddUnsafe(t, e, r) {
                      let n = d.BASE,
                        i = (t, e) =>
                          e !== tb && e !== tx && t.equals(n) ? t.multiply(e) : t.multiplyUnsafe(e),
                    ...
                    clearCofactor() {
                      ...
                      return t === tx ? this : e ? e(d, this) : this.multiplyUnsafe(r.h);
                    }
                    toRawBytes(t = !0) {
                      return b("isCompressed", t), this.assertValidity(), o(d, this, t);
                    }
                    toHex(t = !0) {
                      return b("isCompressed", t), E(this.toRawBytes(t));
                    }
                  }
                  (d.BASE = new d(r.Gx, r.Gy, n.ONE)), (d.ZERO = new d(n.ZERO, n.ONE, n.ZERO));
                  let c = r.nBitLength,
                    g =
                      ((e = r.endo ? Math.ceil(c / 2) : c),
                      {
                        constTimeNegate: tf,
                        hasPrecomputes: (t) => 1 !== td(t),
                        unsafeLadder(t, e, r = d.ZERO) {
                          let n = t;
                          for (; e > to; ) e & ts && (r = r.add(n)), (n = n.double()), (e >>= ts);
                          return r;
                        },
                        precomputeWindow(t, r) {
                          let { windows: n, windowSize: i } = ta(r, e),
                            o = [],
                            s = t,
                            f = s;
                          for (let t = 0; t < n; t++) {
                        ...
                        wNAF(t, r, n) {
                          let { windows: i, windowSize: o } = ta(t, e),
                            s = d.ZERO,
                            f = d.BASE,
                            l = BigInt(2 ** t - 1),
                            a = 2 ** t,
                          ...
                          for (let t = 0; t < i; t++) {
                            let e = t * o,
                              i = Number(n & l);
                            (n >>= u), i > o && ((i -= a), (n += ts));
                            let h = e + Math.abs(i) - 1,
                              d = t % 2 != 0,
                              c = i < 0;
                            0 === i ? (f = f.add(tf(d, r[e]))) : (s = s.add(tf(c, r[h])));
                          }
                          return { p: s, f };
                        },
                        wNAFUnsafe(t, r, n, i = d.ZERO) {
                          let { windows: o, windowSize: s } = ta(t, e),
                            f = BigInt(2 ** t - 1),
                            l = 2 ** t,
                            a = BigInt(t);
                          for (let t = 0; t < o; t++) {
                            ...
                            if (n === to) break;
                            let o = Number(n & f);
                            if (((n >>= a), o > s && ((o -= l), (n += ts)), 0 === o)) continue;
                            let u = r[e + Math.abs(o) - 1];
                        ...
                        getPrecomputes(t, e, r) {
                          let n = tu.get(e);
                          return (
                            n || ((n = this.precomputeWindow(e, t)), 1 !== t && tu.set(e, r(n))), n
                          );
                        },
                        wNAFCached(t, e, r) {
                          let n = td(t);
                  ...
                  fromBytes(t) {
                    ...
                    if (e === i && (2 === n || 3 === n)) {
                      let t,
                        e = S(s);
                      if (!U(e, tx, r.ORDER)) throw Error("Point is not on curve");
                      let i = a(e);
                      try {
                        t = r.sqrt(i);
                      } catch (t) {
                      ...
                      return ((1 & n) == 1) != ((t & tx) === tx) && (t = r.neg(t)), { x: e, y: t };
                    }
                    if (e === o && 4 === n)
                      return {
                ...
                h = (t) => E(R(t, e.nByteLength)),
                d = (t, e, r) => S(t.slice(e, r));
              class c {
                constructor(t, e, r) {
                ...
                static fromCompact(t) {
                  let r = e.nByteLength;
                  return new c(d((t = H("compactSignature", t, 2 * r)), 0, r), d(t, r, 2 * r));
                }
                static fromDER(t) {
                  let { r: e, s: r } = tm.toSig(H("DER", t));
                  return new c(e, r);
                }
                assertValidity() {
                  z("r", this.r, tx, n), z("s", this.s, tx, n);
                }
                addRecoveryBit(t) {
                  return new c(this.r, this.s, t);
                }
                recoverPublicKey(t) {
                ...
                normalizeS() {
                  return this.hasHighS() ? new c(this.r, s(-this.s), this.recovery) : this;
                }
                toDERRawBytes() {
                  return I(this.toDERHex());
                }
                toDERHex() {
                  return tm.hexFromSig({ r: this.r, s: this.s });
                }
                toCompactRawBytes() {
              ...
              let p =
                ...
                m = F(e.nBitLength);
              function x(t) {
                return z("num < 2^" + e.nBitLength, t, tb, m), R(t, e.nByteLength);
              }
              let B = { lowS: e.lowS, prehash: !1 },
                v = { lowS: e.lowS, prehash: !1 };
              return (
                f.BASE._setWindowSize(8),
                {
                  ...
                  getSharedSecret: function (t, e, r = !0) {
                    if (g(t)) throw Error("first arg must be private key");
                    if (!g(e)) throw Error("second arg must be public key");
                    return f.fromHex(e).multiply(l(t)).toRawBytes(r);
                  },
                  sign: function (t, i, o = B) {
                    let { seed: a, k2sig: h } = (function (t, i, o = B) {
                      if (["recovered", "canonical"].some((t) => t in o))
                        throw Error("sign() legacy options not supported");
                      let { hash: a, randomBytes: h } = e,
                        { lowS: d, prehash: g, extraEntropy: y } = o;
                      null == d && (d = !0),
                        (t = H("msgHash", t)),
                        tg(o),
                        g && (t = H("prehashed msgHash", a(t)));
                      let m = w(t),
                        b = l(i),
                        E = [x(b), x(m)];
                      if (null != y && !1 !== y) {
                        let t = !0 === y ? h(r.BYTES) : y;
                        E.push(H("extraEntropy", t));
                      }
                      return {
                        seed: C(...E),
                        k2sig: function (t) {
                          ...
                          if (!u(r)) return;
                          let i = $(r, n),
                            o = f.BASE.multiply(r).toAffine(),
                            l = s(o.x);
                          if (l === tb) return;
                          let a = s(i * s(m + l * b));
                          if (a === tb) return;
                          let h = (2 * (o.x !== l)) | Number(o.y & tx),
                            g = a;
                          return (
                            d && a > n >> tx && ((g = (e = a) > n >> tx ? s(-e) : e), (h ^= 1)),
                            new c(l, g, h)
                          );
                        },
                      };
                    })(t, i, o);
                    return k(e.hash.outputLen, e.nByteLength, e.hmac)(a, h);
                  },
                  verify: function (t, r, i, o = v) {
                    let l, a;
                    (r = H("msgHash", r)), (i = H("publicKey", i));
                    let { lowS: u, prehash: h, format: d } = o;
                    if ((tg(o), "strict" in o)) throw Error("options.strict was renamed to lowS");
                    if (void 0 !== d && "compact" !== d && "der" !== d)
                      throw Error("format must be compact or der");
                    let g = "string" == typeof t || y(t),
                      p =
                        !g &&
                        !d &&
                        "object" == typeof t &&
                    ...
                    try {
                      if ((p && (a = new c(t.r, t.s)), g)) {
                        try {
                          "compact" !== d && (a = c.fromDER(t));
                        } catch (t) {
                          if (!(t instanceof tm.Err)) throw t;
                        }
                        a || "der" === d || (a = c.fromCompact(t));
                      }
                      l = f.fromHex(i);
                    } catch (t) {
                      return !1;
                    ...
                    let { r: m, s: b } = a,
                      ...
                      B = s(x * E),
                      A = s(m * E),
                      O = f.BASE.multiplyAndAddUnsafe(l, B, A)?.toAffine();
                    return !!O && s(O.x) === m;
                  },
                  ProjectivePoint: f,
                  Signature: c,
                  utils: {
                    ...
                    randomPrivateKey: () => {
                      ...
                      return (function (t, e, r = !1) {
                        ...
                        let s = Q(r ? q(t) : S(t), e - K) + K;
                        return r ? N(s, i) : R(s, i);
                      })(e.randomBytes(t), e.n);
                    },
              ...
              ...t,
              ...{ hash: e, hmac: (t, ...r) => c(e, t, (0, o.Id)(...r)), randomBytes: o.po },
            });
          return { ...r(e), create: r };
        })(
          {
            ...
            endo: {
              ...
              splitScalar: (t) => {
                let e = BigInt("0x3086d221a7d46bcde86c90e49284eb15"),
                  r = -tA * BigInt("0xe4437ed6010e88286f547fa90abfe4c3"),
                  ...
                  a = f > i,
                  u = l > i;
                if ((a && (f = tv - f), u && (l = tv - l), f > i || l > i))
                  throw Error("splitScalar: Endomorphism failed, k=" + t);
                return { k1neg: a, k1: f, k2neg: u, k2: l };
              },
            },
          },
          h,
        ...
        tR = (BigInt(0), {}),
        tN = (t) => t.toRawBytes(!0).slice(1),
        tH = (t) => mod(t, tv),
        tC = tq.ProjectivePoint;
    },
  },
]);
