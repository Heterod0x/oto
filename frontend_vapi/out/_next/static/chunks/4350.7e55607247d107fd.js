...
`;
      var c = function (e, t, r, i) {
        ...
        if ("object" == typeof Reflect && "function" == typeof Reflect.decorate)
          ...
          for (var n = e.length - 1; n >= 0; n--)
            (a = e[n]) && (s = (o < 3 ? a(s) : o > 3 ? a(t, r, s) : a(t, r)) || s);
    ...
    `;
      ...
      (l.styles = [o.W5, o.fD, n]),
        c([(0, a.MZ)()], l.prototype, "variant", void 0),
        c([(0, a.MZ)()], l.prototype, "imageSrc", void 0),
        c([(0, a.MZ)({ type: Boolean })], l.prototype, "disabled", void 0),
        c([(0, a.MZ)()], l.prototype, "icon", void 0),
        c([(0, a.MZ)()], l.prototype, "size", void 0),
        c([(0, a.MZ)()], l.prototype, "text", void 0),
    ...
    27239: (e, t, r) => {
      ...
      let n = {
        generate({ uri: e, size: t, logoSize: r, dotColor: a = "#141414" }) {
          let n = [],
            c = (function (e, t) {
              let r = Array.prototype.slice.call(
                  o.create(e, { errorCorrectionLevel: "Q" }).modules.data,
                  0,
                ),
          ...
          return (
            ...
            Object.entries(g)
              .map(([e, t]) => {
                let r = t.filter((e) => t.every((t) => !s(e, t, l)));
                return [Number(e), r];
              })
              .forEach(([e, t]) => {
                t.forEach((t) => {
                  n.push((0, i.JW)`<circle cx=${e} cy=${t} fill=${a} r=${l / 2.5} />`);
                });
              }),
            Object.entries(g)
              .filter(([e, t]) => t.length > 1)
              .map(([e, t]) => {
                let r = t.filter((e) => t.some((t) => s(e, t, l)));
                return [Number(e), r];
              })
              .map(([e, t]) => {
                t.sort((e, t) => (e < t ? -1 : 1));
                let r = [];
                for (let e of t) {
                  let t = r.find((t) => t.some((t) => s(e, t, l)));
                  t ? t.push(e) : r.push([e]);
                }
...
`;
    ...
    `;
      ...
      (h.styles = [c.W5, d]),
        u([(0, a.MZ)()], h.prototype, "uri", void 0),
        u([(0, a.MZ)({ type: Number })], h.prototype, "size", void 0),
        u([(0, a.MZ)()], h.prototype, "theme", void 0),
        u([(0, a.MZ)()], h.prototype, "imageSrc", void 0),
        u([(0, a.MZ)()], h.prototype, "alt", void 0),
        u([(0, a.MZ)()], h.prototype, "color", void 0),
        u([(0, a.MZ)({ type: Boolean })], h.prototype, "arenaClear", void 0),
        u([(0, a.MZ)({ type: Boolean })], h.prototype, "farcaster", void 0),
        (h = u([(0, l.E)("wui-qr-code")], h));
    },
    33380: (e, t, r) => {
      var i = r(2776),
        a = r(8847),
...
`;
      ...
      (l.styles = [o.W5, o.ck, n]),
        c([(0, a.MZ)()], l.prototype, "src", void 0),
        c([(0, a.MZ)()], l.prototype, "alt", void 0),
        c([(0, a.MZ)()], l.prototype, "size", void 0),
        (l = c([(0, s.E)("wui-image")], l));
    },
    74350: (e, t, r) => {
      r.r(t), r.d(t, { W3mWalletReceiveView: () => k });
      var i = r(2776),
        a = r(8847),
        o = r(51685),
        s = r(38426),
        ...
        h = r(71644),
        p = r(10021);
      r(21680), r(28563), r(33380), r(80352), r(7614);
      var w = r(24957),
        g = r(93626);
      let v = (0, i.AH)`
  button {
...
`;
    ...
    `;
        ...
        networksTemplate() {
          ...
          return (0, i.qy)` <wui-flex class="networks">
      ${e?.map((e) => (0, i.qy)` <wui-flex class="network-icon"> <wui-image src=${e}></wui-image> </wui-flex>`)}
    </wui-flex>`;
        }
      };
      (f.styles = [w.W5, w.fD, v]),
        b([(0, a.MZ)({ type: Array })], f.prototype, "networkImages", void 0),
        b([(0, a.MZ)()], f.prototype, "text", void 0),
        (f = b([(0, g.E)("wui-compatible-network")], f)),
        r(79824),
        r(27239),
        r(77740);
      var m = r(15256);
...
`;
      ...
      ${this.networkTemplate()}
        ...
        networkTemplate() {
          let e = n.W.getAllRequestedCaipNetworks(),
            ...
            a = e.filter((e) => e?.chainNamespace === r?.chainNamespace);
          if (
            this.preferredAccountTypes?.[r?.chainNamespace] === m.Vl.ACCOUNT_TYPES.SMART_ACCOUNT &&
            t
          )
            return r
              ? (0, i.qy)`<wui-compatible-network
        @click=${this.onReceiveClick.bind(this)}
        text="Only receive assets on this network"
        .networkImages=${[l.$.getNetworkImage(r) ?? ""]}
      ></wui-compatible-network>`
              : null;
          let o = (a?.filter((e) => e?.assets?.imageId)?.slice(0, 5))
            .map(l.$.getNetworkImage)
            .filter(Boolean);
          return (0, i.qy)`<wui-compatible-network
      @click=${this.onReceiveClick.bind(this)}
    ...
    ></wui-compatible-network>`;
        ...
        onCopyClick() {
          try {
            this.address && (h.w.copyToClopboard(this.address), c.P.showSuccess("Address copied"));
          } catch {
      ...
      (k.styles = y),
        x([(0, a.wk)()], k.prototype, "address", void 0),
        x([(0, a.wk)()], k.prototype, "profileName", void 0),
        x([(0, a.wk)()], k.prototype, "network", void 0),
        x([(0, a.wk)()], k.prototype, "preferredAccountTypes", void 0),
