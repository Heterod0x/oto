  ...
  [7341],
  {
    37341: (t, e, o) => {
      ...
      var i = o(2776),
        ...
        d = o(53346),
        w = o(10021);
      o(61823), o(79824), o(69846), o(77740);
      var h = o(15256),
        g = o(13316);
      o(90358), o(88637);
      let k = (0, i.AH)`
...
`;
      var x = function (t, e, o, i) {
        var r,
          a = arguments.length,
          n = a < 3 ? e : null === i ? (i = Object.getOwnPropertyDescriptor(e, o)) : i;
        if ("object" == typeof Reflect && "function" == typeof Reflect.decorate)
          n = Reflect.decorate(t, e, o, i);
        else
          for (var s = t.length - 1; s >= 0; s--)
            (r = t[s]) && (n = (a < 3 ? r(n) : a > 3 ? r(e, o, n) : r(e, o)) || n);
          ...
          render() {
            let t =
              this.toTokenAmount && this.maxSlippage
                ? a.S.bigNumber(this.toTokenAmount).minus(this.maxSlippage).toString()
                : null;
      ...
      let T = {
        numericInputKeyDown(t, e, o) {
          let i = t.metaKey || t.ctrlKey,
            ...
            s = "." === r,
            l = r >= "0" && r <= "9";
          i || ("a" !== a && "c" !== a && "v" !== a && "x" !== a) || t.preventDefault(),
...
`;
    ...
    `;
        ...
        handleKeydown(t) {
          return T.numericInputKeyDown(t, this.value, (t) => this.onSetAmount?.(this.target, t));
        }
    ...
    `;
        ...
        tokenActionButtonTemplate(t) {
          return t
            ? (0,
              i.qy)` <button class="max-value-button" @click=${this.setMaxValueToInput.bind(this)}>
        <wui-text color="accent-100" variant="small-600">Max</wui-text>
      </button>`
            : (0, i.qy)` <button class="max-value-button" @click=${this.onBuyToken.bind(this)}>
...
`;
      ...
      let D = class extends i.WF {
        ...
        async firstUpdated() {
          c.GN.initializeState(), this.watchTokensAndValues(), await this.handleSwapParameters();
        }
    ...
    `;
        ...
        watchTokensAndValues() {
          this.interval = setInterval(() => {
            c.GN.getNetworkTokenPrice(), c.GN.getMyTokensWithBalance(), c.GN.swapTokens();
          }, 1e4);
        }
        templateSwap() {
          return (0, i.qy)`
    ...
    `;
        ...
        templateTokenInput(t, e) {
          let o = c.GN.state.myTokensWithBalance?.find((t) => t?.address === e?.address),
            r = "toToken" === t ? this.toTokenAmount : this.sourceTokenAmount,
            n = "toToken" === t ? this.toTokenPriceInUSD : this.sourceTokenPriceInUSD,
    ...
    ></w3m-swap-input>`;
        ...
        templateDetails() {
          return this.sourceToken && this.toToken && !this.inputError
            ? (0, i.qy)`<w3m-swap-details .detailsOpen=${this.detailsOpen}></w3m-swap-details>`
            : null;
        }
        handleChangeAmount(t, e) {
          c.GN.clearError(),
            "sourceToken" === t ? c.GN.setSourceTokenAmount(e) : c.GN.setToTokenAmount(e),
      ...
      >
          ...
          this.fetchError && (await c.GN.swapTokens()),
            d.E.sendEvent({
              ...
              properties: {
                ...
                isSmartAccount:
                  s.U.state.preferredAccountTypes?.[t] === h.Vl.ACCOUNT_TYPES.SMART_ACCOUNT,
              },
            }),
        ...
        async setSwapParameters({ amount: t, fromToken: e, toToken: o }) {
          ...
          let i = [...(c.GN.state.tokens || []), ...(c.GN.state.myTokensWithBalance || [])];
          if (e) {
        ...
        onCaipAddressChange({ newCaipAddress: t, resetSwapState: e, initializeSwapState: o }) {
          this.caipAddress !== t &&
            ((this.caipAddress = t), e && c.GN.resetState(), o && c.GN.initializeState());
        }
...
`;
      ...
      let G = class extends i.WF {
        constructor() {
          super(),
            ...
            (this.inputError = c.GN.state.inputError),
            (this.loadingQuote = c.GN.state.loadingQuote),
            (this.loadingApprovalTransaction = c.GN.state.loadingApprovalTransaction),
    ...
    `;
        ...
        templateSwap() {
          let t = `${w.Zv.formatNumberToLocalString(parseFloat(this.sourceTokenAmount))} ${this.sourceToken?.symbol}`,
            e = `${w.Zv.formatNumberToLocalString(parseFloat(this.toTokenAmount))} ${this.toToken?.symbol}`,
...
`;
      ...
      let M = class extends i.WF {
        ...
        render() {
          ...
          let t =
            this.amount && this.price ? a.S.multiply(this.price, this.amount)?.toFixed(3) : null;
          return (0, i.qy)`
...
`;
      ...
      let L = class extends i.WF {
        ...
        updated() {
          ...
          t?.addEventListener("scroll", this.handleSuggestedTokensScroll.bind(this));
        ...
        disconnectedCallback() {
          ...
          t?.removeEventListener("scroll", this.handleSuggestedTokensScroll.bind(this)),
            e?.removeEventListener("scroll", this.handleTokenListScroll.bind(this)),
    ...
    `;
        ...
        onSelectToken(t) {
          "sourceToken" === this.targetToken
            ...
            : (c.GN.setToToken(t), this.sourceToken && this.sourceTokenAmount && c.GN.swapTokens()),
            n.I.goBack();
        }
        templateSearchInput() {
          return (0, i.qy)`
    ...
    `;
        ...
        templateTokens() {
          let t = this.myTokensWithBalance ? Object.values(this.myTokensWithBalance) : [],
    ...
    `;
        ...
        templateSuggestedTokens() {
          let t = c.GN.state.suggestedTokens ? c.GN.state.suggestedTokens.slice(0, 8) : null;
          return t
            ? (0, i.qy)`
        ...
        handleSuggestedTokensScroll() {
          ...
          t &&
            ...
            t.style.setProperty(
              ...
              w.z8
                .interpolate([0, 100], [0, 1], t.scrollWidth - t.scrollLeft - t.offsetWidth)
                .toString(),
            ));
        }
        handleTokenListScroll() {
          ...
          t &&
            ...
            t.style.setProperty(
              ...
              w.z8
                .interpolate([0, 100], [0, 1], t.scrollHeight - t.scrollTop - t.offsetHeight)
                .toString(),
            ));
        }
        filterTokensWithText(t, e) {
          return t.filter((t) =>
            `${t.symbol} ${t.name} ${t.address}`.toLowerCase().includes(e.toLowerCase()),
          );
        }
      };
      (L.styles = q),
      ...
      let n = (0, i.BX)({
        ...
        s = (0, a.X)({
          ...
          showTooltip({ message: t, triggerRect: e, variant: o }) {
            (n.open = !0), (n.message = t), (n.triggerRect = e), (n.variant = o);
          },
          hide() {
            (n.open = !1),
              (n.message = ""),
    ...
    `;
        ...
        onMouseEnter() {
          ...
          this.open ||
            a.I.showTooltip({
              message: this.text,
              triggerRect: { width: t.width, height: t.height, left: t.left, top: t.top },
              variant: "shade",
            });
        }
        onMouseLeave(t) {
