            ...
            let y = (function (t, e, r) {
                ...
                return (function (t, e, r) {
                  let o,
                    ...
                    l = a - f.getTotalCodewordsCount(e, r),
                  ...
                  let B = new Uint8Array(a),
                    I = 0;
                  for (o = 0; o < C; o++)
                    for (i = 0; i < u; i++) o < w[i].length && (B[I++] = w[i][o]);
          ...
          let o = (function (t, e) {
              ...
              for (let a = 0; a < t.length; a++) {
                ...
                for (let t = 0; t < l.length; t++) {
                  let s = l[t],
                    f = "" + a + t;
                  u.push(f), (r[f] = { node: s, lastCount: 0 }), (o[f] = {});
                  for (let t = 0; t < i.length; t++) {
                    let a = i[t];
                    r[a] && r[a].node.mode === s.mode
                      ? ((o[a][f] =
                          d(r[a].lastCount + s.length, s.mode) - d(r[a].lastCount, s.mode)),
                        (r[a].lastCount += s.length))
                      : (r[a] && (r[a].lastCount = s.length),
                        (o[a][f] = d(s.length, s.mode) + 4 + n.getCharCountIndicator(s.mode, e)));
                  }
                }
                i = u;
              }
          ...
          for (let u = 0; u < e; u++) {
            ...
            for (let s = 0; s < e; s++) {
              ...
              e === a ? o++ : (o >= 5 && (n += r.N1 + (o - 5)), (a = e), (o = 1)),
                (e = t.get(s, u)) === l ? i++ : (i >= 5 && (n += r.N1 + (i - 5)), (l = e), (i = 1));
            }
    ...
    90981: (t, e, r) => {
      ...
      e.render = function (t, e, r) {
        let a = n.getOptions(e),
          ...
          s = l + 2 * a.margin,
          f = a.color.light.a
            ? "<path " + o(a.color.light, "fill") + ' d="M0 0h' + s + "v" + s + 'H0z"/>'
            : "",
          h =
            "<path " +
              ...
              for (let u = 0; u < t.length; u++) {
                ...
                s || a || (a = !0),
                  t[u]
                    ? (l++,
                      (u > 0 && s > 0 && t[u - 1]) ||
                        ((n += a ? i("M", s + r, 0.5 + f + r) : i("m", o, 0)), (o = 0), (a = !1)),
                      (s + 1 < e && t[u + 1]) || ((n += i("h", l)), (l = 0)))
                    : o++;
              }
              return n;
            })(u, l, a.margin) +
          ...
          for (let e = 0; e < l; e++)
            for (let r = 0; r < l; r++) {
              ...
              e >= u &&
                ...
                e < l - u &&
                r < l - u &&
                (h = s[+!!i[Math.floor((e - u) / a) * o + Math.floor((r - u) / a)]]),
                (t[f++] = h.r),
                (t[f++] = h.g),
                (t[f++] = h.b),
                (t[f] = h.a);
