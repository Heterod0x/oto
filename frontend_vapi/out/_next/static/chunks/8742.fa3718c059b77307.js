    ...
    8742: (e, t, i) => {
      i.r(t),
        i.d(t, {
          ...
          W3mOnRampProvidersView: () => D,
          W3mOnrampFiatSelectView: () => T,
          W3mOnrampTokensView: () => U,
          W3mOnrampWidget: () => er,
          W3mWhatIsABuyView: () => V,
        });
      var r = i(2776),
        ...
        p = i(19495),
        d = i(10021);
      i(79824), i(77740), i(6679);
      var h = i(40369);
      i(7390), i(15448), i(23125);
      let w = (0, r.AH)`
  :host {
    width: 100%;
  }
...
`;
      var m = function (e, t, i, r) {
        ...
        if ("object" == typeof Reflect && "function" == typeof Reflect.decorate)
          ...
          for (var n = e.length - 1; n >= 0; n--)
            (o = e[n]) && (s = (a < 3 ? o(s) : a > 3 ? o(t, i, s) : o(t, i)) || s);
    ...
    ></wui-icon-box>`;
        ...
        imageTemplate() {
          let e = this.icon || `https://avatar.vercel.sh/andrew.svg?size=50&text=${this.symbol}`;
        ...
        refetchLoadingTransactions() {
          ...
          if (
            ...
            (this.coinbaseTransactions[e.getFullYear()]?.[e.getMonth()] || []).filter(
              (e) => "ONRAMP_TRANSACTION_STATUS_IN_PROGRESS" === e.metadata.status,
            ).length
          )
            return void clearTimeout(this.refetchTimeout);
          this.refetchTimeout = setTimeout(async () => {
            let e = u.U.state.address;
            await c.W.fetchTransactions(e, "coinbase"), this.refetchLoadingTransactions();
          }, 3e3);
        }
        templateLoading() {
          return Array(7)
            .fill(
              (0, r.qy)` <wui-transaction-list-item-loader></wui-transaction-list-item-loader> `,
            )
            .map((e) => e);
        }
      };
        ...
        constructor() {
          super(),
            ...
            this.unsubscribe.push(
              ...
              l.j.subscribeKey("currencyImages", (e) => (this.currencyImages = e)),
...
`;
    ...
    `;
      ...
      (_.styles = [M]),
        S([(0, o.MZ)({ type: Boolean })], _.prototype, "disabled", void 0),
        S([(0, o.MZ)()], _.prototype, "color", void 0),
        S([(0, o.MZ)()], _.prototype, "name", void 0),
        S([(0, o.MZ)()], _.prototype, "label", void 0),
        S([(0, o.MZ)()], _.prototype, "feeRange", void 0),
        S([(0, o.MZ)({ type: Boolean })], _.prototype, "loading", void 0),
        S([(0, o.MZ)()], _.prototype, "onClick", void 0),
        (_ = S([(0, d.EM)("w3m-onramp-provider-item")], _)),
        i(16877);
      let q = (0, r.AH)`
  wui-flex {
      ...
      How does it work?
          ...
          onWhatIsBuy() {
            ...
            $.E.sendEvent({
              ...
              properties: {
                isSmartAccount:
                  u.U.state.preferredAccountTypes?.[e] === j.Vl.ACCOUNT_TYPES.SMART_ACCOUNT,
              },
            }),
              R.I.push("WhatIsABuy");
          }
        ...
        (E = (function (e, t, i, r) {
          ...
          if ("object" == typeof Reflect && "function" == typeof Reflect.decorate)
            ...
            for (var n = e.length - 1; n >= 0; n--)
              (o = e[n]) && (s = (a < 3 ? o(s) : a > 3 ? o(t, i, s) : o(t, i)) || s);
          return a > 3 && s && Object.defineProperty(t, i, s), s;
        })([(0, d.EM)("w3m-onramp-providers-footer")], E));
        ...
        firstUpdated() {
          Promise.all(
            this.providers.map(async (e) =>
              "coinbase" === e.name ? await this.getCoinbaseOnRampURL() : Promise.resolve(e?.url),
            ),
          ).then((e) => {
            this.providers = this.providers.map((t, i) => ({ ...t, url: e[i] || "" }));
          });
        }
        render() {
          return (0, r.qy)`
    ...
    `;
        ...
        onRampProvidersTemplate() {
          return this.providers
            .filter((e) => e.supportedChains.includes(I.W.state.activeChain ?? "eip155"))
            .map(
              (e) => (0, r.qy)`
        ...
        onClickProvider(e) {
          ...
          n.aG.setSelectedProvider(e),
            R.I.push("BuyInProgress"),
            A.w.openHref(e.url, "popupWindow", "width=600,height=800,scrollbars=yes"),
            $.E.sendEvent({
              type: "track",
              ...
              properties: {
                provider: e.name,
                isSmartAccount:
                  u.U.state.preferredAccountTypes?.[t] === j.Vl.ACCOUNT_TYPES.SMART_ACCOUNT,
              },
            });
        }
        async getCoinbaseOnRampURL() {
          ...
          let i =
            ...
            o = r ? [r.symbol] : n.aG.state.purchaseCurrencies.map((e) => e.symbol);
          return await O.T.generateOnRampURL({
            defaultNetwork: i,
            destinationWallets: [
              { address: e, blockchains: P.oU.WC_COINBASE_PAY_SDK_CHAINS, assets: o },
            ],
            partnerUserId: e,
      ...
      N([(0, o.wk)()], D.prototype, "providers", void 0),
        (D = N([(0, d.EM)("w3m-onramp-providers-view")], D));
      let G = (0, r.AH)`
  :host > wui-grid {
    max-height: 360px;
    overflow: auto;
...
`;
    ...
    `;
      ...
      (U.styles = G),
        B([(0, o.wk)()], U.prototype, "selectedCurrency", void 0),
        B([(0, o.wk)()], U.prototype, "tokens", void 0),
        B([(0, o.wk)()], U.prototype, "tokenImages", void 0),
        B([(0, o.wk)()], U.prototype, "checked", void 0),
        (U = B([(0, d.EM)("w3m-onramp-token-select-view")], U));
      var L = i(26115),
        z = i(7679),
        Z = i(32736);
      i(61823), i(84219);
    ...
    `;
        ...
        async watchCoinbaseTransactions() {
          try {
            let e = u.U.state.address;
            if (!e) throw Error("No address found");
            (await O.T.fetchTransactions({ account: e, onramp: "coinbase" })).data.filter(
              (e) =>
                new Date(e.metadata.minedAt) > new Date(this.startTime) ||
                "ONRAMP_TRANSACTION_STATUS_IN_PROGRESS" === e.metadata.status,
            ).length
              ? (clearInterval(this.intervalId), R.I.replace("OnRampActivity"))
              : this.startTime &&
        ...
        tryAgainTemplate() {
          return this.selectedOnRampProvider?.url
            ? (0, r.qy)`<wui-button size="md" variant="accent" @click=${this.onTryAgain.bind(this)}>
      ...
      Try again
        ...
        loaderTemplate() {
          ...
          return (0, r.qy)`<wui-loading-thumbnail radius=${9 * t}></wui-loading-thumbnail>`;
        }
        onCopyUri() {
          if (!this.selectedOnRampProvider?.url) {
            z.P.showError("No link found"), R.I.goBack();
            return;
          }
          try {
            A.w.copyToClopboard(this.selectedOnRampProvider.url), z.P.showSuccess("Link copied");
          } catch {
            z.P.showError("Failed to copy");
          }
        }
      };
      (K.styles = H),
...
`;
      ...
      let Q = class extends r.WF {
        ...
        render() {
          ...
          return (0, r.qy)`<wui-input-text type="number" size="lg" value=${this.value}>
      ${
        ...
        er = class extends r.WF {
          constructor() {
            super(),
              ...
              this.unsubscribe.push(
                I.W.subscribeKey("activeCaipAddress", (e) => (this.caipAddress = e)),
