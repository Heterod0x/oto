    ...
    `;
      ...
      (l.styles = [i.W5, a]),
        (l = (function (e, r, o, t) {
          var i,
            s = arguments.length,
            a = s < 3 ? r : null === t ? (t = Object.getOwnPropertyDescriptor(r, o)) : t;
          if ("object" == typeof Reflect && "function" == typeof Reflect.decorate)
            a = Reflect.decorate(e, r, o, t);
          else
            for (var l = e.length - 1; l >= 0; l--)
              (i = e[l]) && (a = (s < 3 ? i(a) : s > 3 ? i(r, o, a) : i(r, o)) || a);
...
`;
   ...
   `),
            (0, t.qy)` <wui-icon color=${this.iconColor} size=${e} name=${this.icon}></wui-icon> `
          );
        }
      };
